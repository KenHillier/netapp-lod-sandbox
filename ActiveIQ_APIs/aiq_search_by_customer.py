...
def main():
    ...
    parser = argparse.ArgumentParser(description="Search for customers using the ActiveIQ API.")
    parser.add_argument(
        "customer_name",
        type=str,
        help="The name of the customer to search for."
    )
    ...
    search_term = args.customer_name
    try:
        customers = search_customers(api_token, search_term)
        pprint(customers)  # Pretty print the response
